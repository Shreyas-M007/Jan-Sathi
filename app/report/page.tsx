    ...
    <section className="grid gap-6 md:grid-cols-[1.15fr_0.85fr]">
      <form onSubmit={onSubmit} className="glass-card p-6">
        ...
        <div className="mt-6 space-y-4">
          ...
          <input value={imageName} onChange={(e) => setImageName(e.target.value)} placeholder="Image filename (simulated upload)" className="w-full rounded-md border border-indigo-200 bg-white/90 px-3 py-2" />
